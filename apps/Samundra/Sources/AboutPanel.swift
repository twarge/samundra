...
enum AboutPanel {
    ...
    private static func credits() -> NSAttributedString {
        ...
        text.append(
            NSAttributedString(
                string: "Reads Ocean Optics HR4000 spectrometers, including the HR4000CG.\n\n",
                attributes: body))
        ...
        text.append(
            NSAttributedString(
                string: """
                    Samundra is an independent product and is not affiliated with, \
                    endorsed by, or sponsored by Ocean Optics.\n\n
                    """,
        ...
        text.append(
            NSAttributedString(
                string: ". Atomic line identifications use data extracted from the ",
                attributes: secondary))
        text.append(
            link(
                "NIST Atomic Spectra Database",
                url: URL(string: "https://physics.nist.gov/asd")!,
                attributes: secondary))
